...
enginei = pyttsx3.init("sapi5")
enginei.setProperty("rate", 150)
voice = enginei.getProperty("voices")
enginei.setProperty('voice', voice[1].id)
...
class talkBack:
    ...
    def talk(self, com):
        ...
        elif(com == self.amaz[0]): return self.amazOut
        elif(com == self.amaz[1]): return self.amazOut
        elif(com == self.amaz[2]): return self.amazOut
        elif(com == self.amaz[3]): return self.amazOut
